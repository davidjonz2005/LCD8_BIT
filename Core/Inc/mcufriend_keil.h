...
// general purpose pin macros
 ...
 #define RD_OUTPUT  Gp_out(RD_PORT,RD_PIN)
 ...
 #define WR_OUTPUT  Gp_out(WR_PORT,WR_PIN)
 ...
 #define CD_OUTPUT  Gp_out(CD_PORT, CD_PIN)
 ...
 #define CS_OUTPUT  Gp_out(CS_PORT, CS_PIN)
 ...
 #define RESET_OUTPUT  Gp_out(RESET_PORT, RESET_PIN)
